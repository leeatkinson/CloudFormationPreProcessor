...
.option("-e --extension [extension]", "Processed extension - if blank, overwrites template []", "")
.parse(process.argv);

lib(commander.region, commander.configFilePattern, commander.workingDirectory, commander.compact, commander.processedExtension);
